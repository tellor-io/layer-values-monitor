...
from layer_values_monitor.custom_types import AggregateReport, PowerThresholds, Reporter, ReporterQueryResponse
...
class TestPowerThresholds:
            ...
            "reporters": [
                {
                    ...
                    "power": "50",
                    "metadata": {"jailed": False, "moniker": "reporter1"},
                },
                {
                    "address": "tellor1qma4ngrq2vqz6j82u548lder3ue6m25agqv9rt",
                    "power": "30",
                    "metadata": {"jailed": False, "moniker": "reporter2"},
                },
                {
                    "address": "tellor1q7pamj7v8d3wue5t5pwgejktajrnhuzzthwfel",
                    "power": "20",
                    "metadata": {"jailed": True, "moniker": "jailed_reporter"},
                },
            ]
        }
    ...
    def power_thresholds(self):
        ...
        return PowerThresholds(immediate_pause_threshold=0.66, delayed_pause_threshold=0.33)
    ...
    @pytest.mark.asyncio
    async def test_calculate_power_percentage_delayed_pause(self, power_thresholds, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_calculate_power_percentage_no_pause(self, power_thresholds, mock_logger):
