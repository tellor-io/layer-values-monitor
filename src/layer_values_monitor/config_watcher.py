...
class ConfigWatcher:
    ...
    def reload_config(self) -> bool:
        ...
        if current_mtime > self.last_modified_time:
            logger.info(f"CONFIG DEBUG: Config file modified, reloading...")
            ...
            logger.debug(f"CONFIG DEBUG: Config file unchanged, skipping reload")
        return False
    ...
    def _validate_config(self) -> None:
        ...
        logger.debug(f"CONFIG DEBUG: Validating configuration structure...")
        ...
        logger.debug(f"CONFIG DEBUG: Configuration validation completed")
